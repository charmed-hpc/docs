...
we can use a [proxy charm](https://juju.is/docs/sdk/charm-taxonomy#heading--proxy) in order to expose
...
`filesystem-client` is a [subordinate charm](https://juju.is/docs/juju/relation#heading--subordinate)
