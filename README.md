...
To start the development server locally and render a preview, follow step one from the [Pull Request] section(./CONTRIBUTING.md#pull-requests) of the [CONTRIBUTING](./CONTRIBUTING.md) file and then run:
